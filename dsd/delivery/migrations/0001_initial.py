    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.IntegerField(primary_key=True, serialize=False, unique=True)),
                ('receiver_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='delivery.receiver_info')),
                ('sender_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='delivery.sender_info')),
            ],
        ),
    ]
